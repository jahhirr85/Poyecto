...
int main(int argc, char** argv) {
	...
	int montoventa=0, fact=0, sumgaleria=0, sumpalco=0, acugaleria=0, acupalco=0, totaltiquetes=0;
	float promgeneral=0, totalacu=0;
	do {
		fact++;
		system("cls");
	...
	printf("\nAcumulado general de dinero:				%.0f", totalacu);
	printf("\nPromedio general por ventas:				%0.1f", promgeneral);
